...
Original article on JetsonHacks: 
...
To test the camera: https://wp.me/p7ZgI9-19v
...
Please note that if you are using earlier versions of OpenCV (most likely installed from the Ubuntu repository), you
